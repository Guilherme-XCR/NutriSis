...
public class DlgAdicionarDietaNutricionista extends javax.swing.JDialog {

    private Dieta dieta;
    private DietaController dietaController;
    
    public DlgAdicionarDietaNutricionista(java.awt.Dialog parent, boolean modal, Dieta dieta) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        panMainLayout.setHorizontalGroup(
            ...
            .addComponent(lblTituloDietas, javax.swing.GroupLayout.DEFAULT_SIZE, 500, Short.MAX_VALUE)
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        Dieta d = (Dieta) this.getObjetoSelecionadoNaGridDieta();
